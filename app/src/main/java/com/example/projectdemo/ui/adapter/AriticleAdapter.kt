...
import com.example.projectdemo.ext.setAdapterAnimation
import com.example.projectdemo.ext.toHtml
import com.example.projectdemo.weight.CollectView
    ...
    init {
      //  setAdapterAnimation(SettingUtil.getListMode())
        ...
        getMultiTypeDelegate()?.let {
            ...
            it.addItemType(Project, R.layout.item_project2)
        }
    }
